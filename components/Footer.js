...
const navigation = [
    {
      name: 'GitHub',
      href: 'https://github.com/josedguti/covid-19-nextjs',
      target: '_blank',
      icon: (props) => (
  ...
  export default function Footer() {
    ...
    <div className="max-w-7xl mx-auto py-3 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
      ...
      <div className="mt-2 md:mt-0 md:order-1">
        <p className="text-center text-base text-white text-sm font-medium">&copy; {new Date().getFullYear()} COVID-19 Tracker. All rights reserved.</p>
      </div>
    </div>
  </footer>
    )
